...
preCOVIDtoDTotal = lm(prcDTotal~ObesityPrc+ElderlyPrc+SpendingPerCap, data=europe.highest.DTotal); summary(preCOVIDtoDTotal); anova(preCOVIDtoDTotal)  #
...
plot(europe.highest.DTotal$SpendingPerCap, europe.highest.DTotal$prcDTotal)
