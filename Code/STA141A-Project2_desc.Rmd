...
eu.mean.cases = sum(europecovid$prcCNew)/422
eu.median.cases = median(europecovid$prcCNew)
eu.stats = data.frame(eu.total.cases, eu.total.deaths, eu.total.mortality, eu.mean.cases, eu.median.cases)
names(eu.stats) = c("Total Cases", "Total Deaths", "Total Mortality (as %)", "Mean of % Changes in Case Numbers", "Median of % Changes in Case Numbers")
