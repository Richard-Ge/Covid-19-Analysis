...
totalcases = NULL  ## TODO: mutate covid dataframe with country population first! get summary statistics e.g. total deaths (+ per region), percent of country infected, 
```
