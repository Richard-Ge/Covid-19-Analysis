...
#### TODO: scale() outcome variables before creating models!
...
plot(europe.highest.DNew$AQI, europe.highest.DNew$prcDNew)
plot(europe.highest.DNew$km.density, europe.highest.DNew$prcDNew)
